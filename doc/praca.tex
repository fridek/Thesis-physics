...
\author{Sebastian Porêba}
\shortauthor{Sebastian Porêba}

\titlePL{Porównanie silników fizyki 3D}
\titleEN{Comparison of 3D physics engines}

\shorttitlePL{Porównanie silników fizyki 3D} % skrócona 
\shorttitleEN{Comparison of 3D physics engines}

\thesistypePL{Praca magisterska}
\thesistypeEN{Master of Science Thesis}

\supervisorPL{dr hab. Pawe³ Wêgrzyn}
\supervisorEN{Pawe³ Wêgrzyn Ph.D}
...
\acknowledgements{Serdecznie podziêkowania dla ...}
